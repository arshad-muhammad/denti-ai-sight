    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4">
              Advanced AI-powered periodontal analysis for modern dental practices.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-muted-foreground">
                <Mail className="w-4 h-4" />
                <span>support@periovision.com</span>
              </div>
              <div className="flex items-center space-x-2 text-muted-foreground">
              ...
              <div className="flex items-center space-x-2 text-muted-foreground">
                ...
                <span>123 Medical Drive, Suite 100</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/new-case" className="text-muted-foreground hover:text-primary">
                  New Case
                </Link>
              </li>
              <li>
        ...
        <div className="text-center text-muted-foreground">
          <p>&copy; {currentYear} PerioVision. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
